...
- Captação de clientes em escala — primeiro a casa precisa estar de pé (marca + site + redes)
- Definição rígida de papéis — por ora os dois fazem de tudo de propósito, pra conhecer todos os processos

## Contexto com prazo

- (sem prazos fixos definidos ainda — registrar conforme forem estabelecidos)

---

**Candidatas a virar skill** (rodar `/mapear-rotinas` quando o padrão ficar claro):
- Montar o workflow/divisão de processos e funções da agência
- Padrão de criação de site dark/tech pra clientes (vira entregável recorrente)
